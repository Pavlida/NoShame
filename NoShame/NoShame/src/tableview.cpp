...
void TableView::setupCustomMenu()
{
    ...
    tMenu->addAction("Add item to your meal", this, SLOT(customMenuAdd()));
    tMenu->addAction("Remove item from the menu", this, SLOT(customMenuRemove()));
    tMenu->addAction("View item details", this, SLOT(customMenuDetails()));
